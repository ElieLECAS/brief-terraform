...
# 
# NOTE: Le provider Microsoft.App doit être enregistré avant d'exécuter terraform apply
# 
# Vérifier l'état: az provider show --namespace Microsoft.App --query "registrationState"
# Si "NotRegistered", essayer: az provider register --namespace Microsoft.App
# 
# Si erreur AuthorizationFailed: le provider peut déjà être enregistré au niveau de l'abonnement.
# Vérifiez avec la commande show ci-dessus. Si "Registered", vous pouvez continuer.
